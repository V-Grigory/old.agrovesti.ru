            ...
            <div class="container">
                @if( session('reason_access_denied') == 'new_client' )
                    <div class="wait_authorize">
                        ...
                        Для авторизации и получения доступа к материалам обратитесь в клиентский
                        отдел по телефонам: 8-905-858-88-19, 8-905-858-87-34 или по e-mail: agrotmn2016@mail.ru.
                    </div>
                @endif
